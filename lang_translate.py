...
def my_trans():
    ...
    while True:
       ...
       speaking("which language you want to tell")
       lang=command()
       lang=lang.replace("jarvis",'')
       word='ok sir.. tell the line'
       speaking(word)
    
       take_text=lang_Command(lang) #take line

       #choice convert language : destinationa lang
       choice_lang='sir..which language you want to translate'
       ...
       speaking("Are you want to translate more sentance")
       word=command()
       li_stop=['stop','no more','end','no thank you','no thanks','off','close','no']
       i=0
       f=0
       while(i<len(li_stop)):
            ...
            i=i+1
       if(f==1):
           speaking("Ok sir...translator closed sucessfully")
           break
